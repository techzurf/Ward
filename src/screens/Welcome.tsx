...
export function Welcome({ navigate }: { navigate: (s: Screen, params?: any) => void }) {
  return (
    <div className="flex-1 bg-[#E5E5E5] flex flex-col min-h-screen relative overflow-hidden">
      ...
      <div className="flex-1 p-8 flex flex-col justify-center relative z-10">
        <div className="mb-10 text-center">
          <h1 className="text-4xl sm:text-5xl font-bold text-black mb-4 uppercase tracking-tighter leading-tight break-words">Chennai Saidapet<br/><span className="text-[#D71920]">Ward</span></h1>
